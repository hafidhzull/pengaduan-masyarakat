                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-6">
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                                <h1 class="h4 text-light-900 mb-4">Registrasi!</h1>
                            </div>
                            <form class="user" method="post" action="<?= base_url('C_zullauth/register') ?>">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?= base_url('C_zullauth') ?>">Sudah Punya Akun? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
